...
exports.default = PeriodicPasswordChangePage;
...
function PeriodicPasswordChangePage() {
    var _this = this;
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 2:
                    ...
                    setTimeout(function () {
                        navigate((0, dashboardPaths_1.getPreferredDashboardPath)(user) || '/dashboard', { replace: true });
                    }, 1500);
                    return [3 /*break*/, 5];
                case 3:
                    err_1 = _e.sent();
