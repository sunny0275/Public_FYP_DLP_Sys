...
interface DashboardSkeletonProps {
  variant?: 'default' | 'admin' | 'manager' | 'security' | 'compliance'
}

export default function DashboardSkeleton({ variant = 'default' }: DashboardSkeletonProps) {
  return (
    <div className="dashboard">
      ...
      <div className="dashboard-grid">
        ...
        {(variant === 'admin' || variant === 'manager' || variant === 'security' || variant === 'compliance') && (
          <div className="dashboard-card">
