...
export default function AdminPage() {
  ...
  const loadUsers = async () => {
    ...
    try {
      ...
      // Filter out archived identities (archived_*), logically deleted accounts, and the built-in admin
      const visibleUsers = (response.data || []).filter((u: User) =>
        !u.accountId.startsWith('archived_') && !u.deletedAt && u.accountId !== 'admin'
      )
